...
% TODO considerazioni per relazione cura, direttore dell'unità operativa, volume Persona
...
\begin{figure}[p]
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
    ...
    \includegraphics[height=0.93\textwidth]{img/logic_final.png}
    \label{img:logic}
  \end{adjustbox}
\end{figure}

\appendix 
\chapter{Query per la creazione del database}
...
\noindent create table APPUNTAMENTO (
...
\noindent create table ATTREZZATURA (
     ...
     constraint IDATTREZZATURA primary key (Codice\textunderscore ospedale, Codice\textunderscore inventario));
     \newline

\noindent create table COINVOLGIMENTO (
...
\noindent create table CURA (
     ...
     constraint IDCURA primary key (Paziente, Codice\textunderscore ospedale, Nome\textunderscore unita)); \newline
...
\noindent create table PAZIENTE (
     ...
     constraint FKPERS\textunderscore PAZIENTE\textunderscore ID primary key (Codice\textunderscore fiscale)); \newline

\noindent create table PERSONA (
     ...
     constraint IDPERSONA\textunderscore ID primary key (Codice\textunderscore fiscale)); \newline
...
\noindent create table UNITA\textunderscore OPERATIVA (
     ...
     constraint IDUNITA\textunderscore OPERATIVA primary key (Codice\textunderscore ospedale, Nome)); \newline
...
\noindent alter table AMMINISTRATIVI add constraint FKPERS\textunderscore AMMINISTRATIVI\textunderscore FK
     ...
     references PERSONA (Codice\textunderscore fiscale); \newline

\noindent alter table AMMINISTRATIVI add constraint FKIMPIEGATI

     foreign key (Codice\textunderscore ospedale)

     references OSPEDALE (Codice\textunderscore struttura); \newline

\noindent alter table APPUNTAMENTO add constraint FKSI\textunderscore SVOLGE

     foreign key (Codice\textunderscore ospedale, Numero\textunderscore sala)

     references SALA (Codice\textunderscore ospedale, Numero); \newline

\noindent alter table APPUNTAMENTO add constraint FKPRENOTA

     foreign key (Paziente)

     references PAZIENTE (Codice\textunderscore fiscale); \newline

\noindent alter table ATTREZZATURA add constraint FKPOSSIEDE

     foreign key (Codice\textunderscore ospedale)

     references OSPEDALE (Codice\textunderscore struttura); \newline

\noindent alter table COINVOLGIMENTO add constraint FKCOI\textunderscore PER

     foreign key (Medico)

     references PERSONALE\textunderscore SANITARIO (Codice\textunderscore fiscale); \newline

\noindent alter table COINVOLGIMENTO add constraint FKCOI\textunderscore REF

     foreign key (Referto)

     references REFERTO (Codice\textunderscore referto); \newline

\noindent alter table CURA add constraint FKCura\textunderscore Unita\textunderscore operativa

     foreign key (Codice\textunderscore ospedale, Nome\textunderscore unita)

     references UNITA\textunderscore OPERATIVA (Codice\textunderscore ospedale, Nome); \newline

\noindent alter table CURA add constraint FKPaziente
...
\noindent alter table OSPEDALE add constraint FKAPPARTENENZA

     foreign key (Cod\textunderscore ASL)

     references ASL (Codice); \newline

\noindent alter table PAZIENTE add constraint FKREGISTRAZIONE

     foreign key (Cod\textunderscore ASL)

     references ASL (Codice); \newline

\noindent alter table PAZIENTE add constraint FKPERS\textunderscore PAZIENTE\textunderscore FK
...
\noindent alter table PRESENZIA add constraint FKPRE\textunderscore APP
     ...
     references APPUNTAMENTO (Codice\textunderscore ospedale, Numero\textunderscore sala, Data\textunderscore ora); \newline
...
\noindent alter table REFERTO add constraint FKEMISSIONE

     foreign key (Codice\textunderscore ospedale)

     references OSPEDALE (Codice\textunderscore struttura); \newline

\noindent alter table REFERTO add constraint FKASSOCIAZIONE

     foreign key (Paziente)

     references PAZIENTE (Codice\textunderscore fiscale); \newline

\noindent alter table SALA add constraint FKSTRUTTURA

     foreign key (Codice\textunderscore ospedale)

     references OSPEDALE (Codice\textunderscore struttura); \newline

\noindent alter table TELEFONO add constraint FKUTENZA

     foreign key (Persona)

     references PERSONA (Codice\textunderscore fiscale); \newline

\noindent alter table UNITA\textunderscore OPERATIVA add constraint FKCOMPOSIZIONE
