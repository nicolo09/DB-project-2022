...
\begin{center}
  \begin{tabular}{ p{269pt} | l }
    ...
    Fissare un appuntamento & 15000 al giorno \\
    ...
    Ricerca di unità operative all'interno di un ospedale & 750 al giorno \\
...
Sono ora descritte le operazioni nel dettaglio con il calcolo del loro costo. A questo fine gli accessi in scrittura vengono considerati 
di costo doppio rispetto a quelli in lettura.
...
Conoscendo già il codice dell'ospedale a cui l'unità operativa da aggiungere dovrà appartenere questa operazione richiede la scrittura dell'entità unità operativa 
